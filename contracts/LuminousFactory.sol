 ...
 * NFT if they participated in LUMOS-FTM farm and have 10K or more WIGO tokens to claim from this pool
 */
contract LuminousFactory is Ownable {
    ...
    uint8 public constant wiggyId = 46;

...
/**
 * @title The Legendary Fusion
 * @notice User has to have at least hold 3,500 $WIGO and 100M $LUMOS in their wallets to be eligible to claim the rewards.
 */
contract LegendaryFusionFactory is Ownable {
    ...
    uint8 public constant wiggyId = 51;
